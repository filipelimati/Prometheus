...
$query = "UPDATE tecnico SET NOME='$nome',COREN='$coren',EMAIL='$email' ,FIXO='$fixo' ,DATANASC='$dataNasc',SEXO='$sexo',CEP='$cep',NUMERO='$endNumero',COMPLEMENTO='$complemento',BAIRRO='$bairro',CIDADE='$cidade',ESTADO='$estado',LOGRADOURO='$logradouro',celular='$celular' WHERE IDTECNICO = '$idtec' ";
