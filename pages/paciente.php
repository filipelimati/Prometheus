                                    ...
                                    if ($resultado = $consulta){
                                      while ($obj = $resultado->fetch_object()){ 
                                        ...
                                        <tr>
                                          ...
                                          <td>                                                  
                                            <button type="button" class="btn btn-xs btn-warning" data-toggle="modal" data-target="#exampleModal" data-whatever="<?php echo $obj->IDPACIENTE; ?>" data-whatevernome="<?php echo $obj->NOME; ?>">Editar</button>
