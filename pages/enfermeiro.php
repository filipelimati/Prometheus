                                    ...
                                    if ($resultado = $consulta){
                                      while ($obj = $resultado->fetch_object()){ 
                                        ...
                                        <tr>
                                          ...
                                          <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel">
                                            <div class="modal-dialog" role="document" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                              <div class="modal-content">
                                                ...
                                                <form role="form" action="exclui_enf.php" method="post">
                                          ...
                                          <button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#myModal" data-whatever="<?php echo $obj->idenfermeiro; ?>" data-whatevernome="<?php echo $obj->nome; ?>" >Apagar</button>
                                          ...
                                          <div class="modal fade bd-example-modal-lg" id="exampleModal" tabindex="-1" role="dialog"   aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                              <div class="modal-content"> 
                                                <div class="modal-header">
                                                  <h4 class="modal-title" id="exampleModalLabel">Editar Enfermeiro</h4>
